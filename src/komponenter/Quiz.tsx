  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between border-b border-kant px-4 py-3">
        ...
        <button onClick={onAfbryd} className="min-h-11 rounded-lg border border-kant px-4 py-2 text-sm text-daempet">
          Afbryd
        </button>
      </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-4">
        <div className="mb-2 flex flex-wrap items-center gap-2">
          <span className="inline-flex min-h-11 items-center rounded-lg border border-kant bg-flade px-3 py-1 text-sm font-semibold text-daempet">
            {aktuelt.kategori}
          </span>
